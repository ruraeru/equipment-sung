...
function Tendious() {
  ...
  button[id="N_myTendinous"] { color: #000; } 
  `;

//   const td_data_state = createGlobalStyle`
//   .data_state { color: #000; }
//   `;
    ...
    const [data, updateData] = useState([
        {id: 0, date: '11/16', title: '교육용', department: '소프트웨어콘텐츠과', name: '스마트패드', code: '9115', state: '대여불가', didIt: false},
        {id: 1, date: '11/16', title: '교육용', department: '소프트웨어콘텐츠과', name: '스마트패드', code: '9115', state: '대여불가', didIt: false},
        {id: 2, date: '11/16', title: '교육용', department: '소프트웨어콘텐츠과', name: '스마트패드', code: '9115', state: '대여불가', didIt: false},
        {id: 3, date: '11/16', title: '교육용', department: '소프트웨어콘텐츠과', name: '스마트패드', code: '9115', state: '대여불가', didIt: false},
        {id: 4, date: '11/16', title: '교육용', department: '소프트웨어콘텐츠과', name: '스마트패드', code: '9115', state: '대여불가', didIt: false}
    ])
        ...
        <div className="all">
          ...
          <div className="t_web">
              ...
              <div className="N_button">
                <button id='N_myList' onClick={goToMyLental}>내 대여내역</button>
                <SubGlobalStyle /><button id='N_myTendinous'>내 건의내역</button>
