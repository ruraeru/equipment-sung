...
import MyLental_Detailed from "./MyLental_Detailed";
...
function Management() {
  ...
  button[id="N_management"] { color: #000; } 
  `;
  ...
  const goToTendious = () => {
    ...
    const [data, updateData] = useState([
        {id: 0, date: '11/16', title: '교육용', department: '소프트웨어콘텐츠과', name: '스마트패드', code: '9115', period: 'TODAY', didIt: false},
        {id: 1, date: '11/16', title: '교육용', department: '소프트웨어콘텐츠과', name: '스마트패드', code: '9115', period: 'D-1', didIt: false},
        {id: 2, date: '11/16', title: '교육용', department: '소프트웨어콘텐츠과', name: '스마트패드', code: '9115', period: 'D-7', didIt: false},
        {id: 3, date: '11/16', title: '교육용', department: '소프트웨어콘텐츠과', name: '스마트패드', code: '9115', period: 'D-14', didIt: false}
    ])
        ...
        <div className="all">
          ...
          <div className="t_web">
              ...
              <div className="N_button">
                ...
                <SubGlobalStyle /><button id='N_management'>대여 관리</button>
              </div>
                ...
                <tbody>
                  {data.map((data, key) => (
                    <tr key={key} onClick = {()=> toggleDidIt(data.id)}style={ data.didIt ? didItStyle:notYetStyle }>
                      ...
                      <td className="td_state">{data.period}</td>
                      <div>{data.didIt && <MyLental_Detailed />}</div>
                    </tr>
                  ))}
                </tbody>
              </table>
